...
function Process(){
  ...
  try{
    ...
    $id("view").innerHTML = "<PRE class='CodeContainer'>"+html+"</PRE>";
  }catch(e){
    alert("JSON数据格式不正确:\n"+e.message);
    $id("view").innerHTML = "";
  }
...
function SelectAllClicked(){
  ...
  if(!!range.selectNode)
    ...
    range.selectNode($id("view"));

  else if(range.moveToElementText)

    range.moveToElementText($id("view"));

  

  if(!!range.select)

    range.select($id("view"));
